  ...
  render: function() {
    return (
      React.createElement("div", {className: "summaryScreen"}, 
        ...
        React.createElement("p", null, "Problems Attempted: ",  this.props.attempted), 
        React.createElement("p", null, "Problems Correct: ",  this.props.correct), 
        React.createElement("p", null, "Correct %: ",  Math.floor(this.props.correct / this.props.attempted * 100), "%"), 
        React.createElement("p", null, "Correct / minute: ",  Math.floor(this.props.correct / this.props.tt) * 1000)
      ));
  }
});
