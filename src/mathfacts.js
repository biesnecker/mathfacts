var CardContainer = React.createClass({
  ...
  render: function() {
    ...
    switch(this.state.majorMode) {
      case "start":
        screen = <StartScreen buttonHandler={this.startButtonPushed} />;
        break;
      case "quiz":
        screen = <QuizScreen summaryHandler={this.handleEndOfQuiz} />;
        break;
      case "summary":
        screen =
          <SummaryScreen
            ...
            startOverHandler={this.handleStartOver} />
        break;
      default:
        screen = "";
        break;
  ...
  render: function() {
    return (
      <div className="startScreen">
        <p className="centered"><img src="owl.png" alt="" /></p>
        <p>Math Facts will help you get better at basic math facts.</p>
        <p>How many can you do?</p>
        <p>Challenge yourself! Let's go! :-)</p>
        <p className="centered">
          <button className="gobutton" onClick={this.props.buttonHandler}>
            GO!
          </button>
        </p>
      </div>
...
var SummaryScreen = React.createClass({
  render: function() {
    return (
      <div className="summaryScreen">
        <p className="centered"><img src="owl2.png" alt="" /></p>
        <p>Attempted: { this.props.attempted }</p>
        <p>Correct: { this.props.correct }</p>
        <p>% Correct: { Math.floor(this.props.correct / this.props.attempted * 100) }%</p>
        <p>Correct / minute: { Math.floor(this.props.correct / (this.props.tt / 1000) * 60) }</p>
        <p className="centered">
          <button className="gobutton" onClick={this.props.startOverHandler}>
            START OVER!
          </button>
        </p>
      </div>
